    ...
    map.addLayer({
        ...
        'layout': {
            'icon-image': [
                ...
                ['==', ['get', 'CAT_MER'], 'Alimentari annessi ad altra attivitq'],'grocery_11',
                ...
                ['==', ['get', 'CAT_MER'], 'Cialde caffl'],'cafe_11',
                ['==', ['get', 'CAT_MER'], 'Enoteca'],'alcohol_shop_11',
                ['==', ['get', 'CAT_MER'], 'Panetteria'],'bakery_11',
                ['==', ['get', 'CAT_MER'], 'Non alimentari annessi ad altre attivit0'],'shop_11',
